...
import com.inkyi.bloomFilter.hashing.HashProvider;
...
public class StableBloomFilter<E> implements CountingBloomFilter<E> {
	...
	public StableBloomFilter(int numberOfCells, int numberOfHashes, float unlearnRate, HashProvider<E> hashProvider) {
