...
public final class Arith {
	 ...
	 * @return 两个参数的和
	 */
	public static String add_jingdu(double v1, double v2) {
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(v2));
		
		return format.format(b1.add(b2));
	}
	 ...
	 * @return 两个参数的差
	 */
	public static String sub_jingdu(double v1, double v2) {
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(v2));
		return format.format(b1.subtract(b2));
	}
	 ...
	 * @return 两个参数的积
	 */
	public static String mul_jingdu(double v1, double v2) {
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(v2));
		return format.format(b1.multiply(b2));
	}
	 ...
	 * @return 两个参数的商
	 */
	public static String div_jingdu(double v1, double v2) {
		return format.format(div(v1, v2, DEF_DIV_SCALE));
	}
	 ...
	 * @return 两个参数的商
	 */
	public static String div_jingdu(double v1, double v2, int scale) {
		if (scale < 0) {
			throw new IllegalArgumentException(
					"The scale must be a positive integer or zero");
		}
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(v2));
		return format.format(b1.divide(b2, scale, BigDecimal.ROUND_HALF_UP));
	}
	 ...
	 * @return 四舍五入后的结果
	 */
	public static String round_jingdu(double v, int scale) {
		if (scale < 0) {
			throw new IllegalArgumentException(
					"The scale must be a positive integer or zero");
		}
		BigDecimal b = new BigDecimal(Double.toString(v));
		BigDecimal one = new BigDecimal("1");
		return format.format( b.divide(one, scale, BigDecimal.ROUND_HALF_UP));
	}

	
	/**
	 * 
	 * 获取double的字符串格式  避免科学技术法的出现
	 */
